...
<section class="ftco-section ">
    <div class="container">
        ...
        <a href="{{url('advokat/pertemuan/'.$p->id)}}">
                    ...
                    <div class="row card-body py-0">
                        ...
                        <div class="col-lg-8 col-md-7 col-sm-6 pl-0">
                            <div class="card-body pb-0">
                                <h5 class="card-title mb-0 font-weight-bold">{{$p->nama}}</h5>
                                <p class="text-info">
                                    @if($p->status== 'WAITING')
                                    Menunggu Advokat
                        ...
                        <div class="col-lg-3 col-md-3 my-auto ">
                            <small class="text-muted d-flex justify-content-end ">{{date('d F Y ', strtotime($p->created_at))}}</small>
                        </div>
