                    ...
                    <div class="col pb-3">
                        <div class="row">
                            <div class="col-sm p-5">
                                @if($pendampingan_detail->client->avatar == '')
                                <img src="{{url('public/avatar.png')}}" class="rounded-circle img-fluid"
                                    style="height: 125px; width:125px;">
                                @else
                                <img src="{{asset($pendampingan_detail->client->avatar)}}"
                                    class="rounded-circle img-fluid" style="height: 125px; width:125px;" alt="...">
                                @endif
                            </div>
                            <div class="col-sm-10  my-auto">
                                <div class="card-text">
                                    <h5 class="font-weight-bold m-0">{{$pendampingan_detail->client->nama_lengkap}}</h5>
                                    <small
                                        class="text-muted">{{date('d F Y  H:i', strtotime($pendampingan_detail->created_at))}}
                                        WIB</small>
                    ...
                    <div class="card-text">
                        ...
                        <div class="col mb-2">
                            ...
                            <h6 class="font-weight-bold mx-auto mb-3">
                                {{$pendampingan_detail->konsultasi->service->nama}}
                            </h6>
                        </div>
                        <div class="col mb-2">
                            <p class="my-auto"> Tanggal dan Waktu Pendampingan</p>
                            <h6 class="font-weight-bold mx-auto  mb-3 ">
                                {{date('l, d F Y  H:i', strtotime($pendampingan_detail->created_at))}} WIB
                            </h6>
                        </div>
                        <div class="col mb-2">
                            <p class="my-auto">Status</p>
                            <h6 class="font-weight-bold mx-auto">
                                @if($pendampingan_detail->status== 'WAITING')
                                Menunggu Advokat
                                @elseif($pendampingan_detail->status =='CONFRIM')
                                Disetujui Advokat
                                @elseif($pendampingan_detail->status =='TOLAK')
                                Ditolak Advokat
                                @elseif($pendampingan_detail->status =='PAID')
                                Sudah Dibayar
                                @elseif($pendampingan_detail->status ==  'WAITING_PAYMENT')
                                Menunggu Pembayaran
                                @else
                                {{$pendampingan_detail->status}}
                                @endif
                                </p>
                            </h6>
                        </div>
                        <div class="col mt-4 ">
                            ...
                            <div class="row">
                                ...
                                <div class="col mb-2">
                                    ...
                                    <h6 class="font-weight-bold mx-auto  mb-3 ">
                                        {{$pendampingan_detail->alasan_tolak}}
                                    </h6>
                                </div>
                                @endif
                            </div>
        ...
        <div class="modal-content ">
            <div class="modal-body mx-3 ">
                <div class="row justify-content-center pt-3">
                    <img src="{{url('public/plugins/fronted-advokat')}}/images/icon/ic-lawyer-selesai.png "
                        style="width: 40%; ">
                </div>
...
<div class="modal fade" id="modal-tolak" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document ">
        <div class="modal-content ">
            <div class="modal-body mx-3 ">
                <div class="row justify-content-center pt-3">
                    <img src="{{url('public/plugins/fronted-advokat')}}/images/icon/ic-lawyer-batal.png"
                        style="width: 40%; ">
                </div>
                <div class="row justify-content-center ">
