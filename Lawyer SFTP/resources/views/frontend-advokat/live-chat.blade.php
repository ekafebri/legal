                ...
                <div class="inbox_chat scroll">
                    <div class="chat_list active_chat">
                        <div class="chat_people">
                            <div class="chat_img"> <img src="{{url('public/plugins/fronted-advokat')}}/images/person_1.jpg" class="img-msg"> </div>
                            <div class="chat_ib">
                    ...
                    <div class="chat_list">
                        <div class="chat_people">
                            <div class="chat_img"> <img src="{{url('public/plugins/fronted-advokat')}}/images/person_2.jpg" class="img-msg"> </div>
                            <div class="chat_ib">
                                <h5>Jamil Saipul</h5>
                    ...
                    <div class="chat_list">
                        <div class="chat_people">
                            <div class="chat_img"> <img src="{{url('public/plugins/fronted-advokat')}}/images/person_3.jpg" class="img-msg"> </div>
                            <div class="chat_ib">
                                <h5>Fajar Nugroho</h5>
                                <p>Terimakasih</p>
                            </div>
                    ...
                    <div class="chat_list">
                        <div class="chat_people">
                            <div class="chat_img"> <img src="{{url('public/plugins/fronted-advokat')}}/images/person_4.jpg" class="img-msg"> </div>
                            <div class="chat_ib">
                                <h5>Boni eriko </h5>
                                <p>Berapa harganya?</p>
                            </div>
