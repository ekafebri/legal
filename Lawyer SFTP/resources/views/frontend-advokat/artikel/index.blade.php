    ...
    <div class="container">
        <div class="row pt-5">
            <div class="col-lg-8 ftco-animate">
                <h2 class="mb-3 pt-5 ">{{$artikel->judul}}</h2>
                <p class="mb-0"><span class="far fa-calendar-alt text-muted "> {{date(' d F Y', strtotime($artikel->release_date))}} &ensp;&bull;</span> <a
                        class="text-danger px-2">Oleh {{$artikel->user->nama_lengkap}}</a>
                </p>
                <p>
                ...
                <div class="d-flex justify-content-between">
                    <div class="">
                        <span class="icon-heart d-flex align-items-center" href="#"> <small>&ensp;{{count($artikel->like)}} suka</small></span>
                    </div>
                    <div class="d-flex align-items-center">
                        <span class="icon-chat  d-flex align-items-center"><small>&ensp;{{count($artikel->comment)}} Komentar</small></span>
                ...
                <!-- komentar -->
                <div class="pt-5 mt-5">
                    <h5 class="mb-5">{{count($artikel->comment)}} Komentar</h5>
                    @if (count($artikel->comment)==0)
            ...
            <div class="col-lg-4 sidebar ftco-animate">
                <div class="sidebar-box ftco-animate">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        ...
                        <div class="text">
                            <h5 class="heading artikel"><a href="{{url('advokat/detailArtikel/'.$a->id)}}">{{$a->judul}}</a>
                            </h5>
                            <div class="meta">
                                <div><a href=""><span class="far fa-calendar-alt"></span>{{date(' d F Y', strtotime($a->release_date))}}</a></div>
                            </div>
                        </div>
                    </div>
                    @endforeach
