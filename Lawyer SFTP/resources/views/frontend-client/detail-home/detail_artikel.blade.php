    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 ftco-animate">
                <h2 class="mb-3">Bantuan Hukum Keliling Mendekatkan Upaya Akses Bantuan</h2>
                <div style="font-size: 16px"><span class="icon-calendar"></span> March 12, 2019 <span
                        class="icon-person"></span> Andira Pramanta</div>

                <p>
                    <img src="{{url('public/plugins/frontend')}}/images/image_3.jpg" alt="" class="img-fluid" />
                </p>
                <p>
                ...
                <div class="sidebar-box ftco-animate">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        <a class="blog-img mr-4"
                            style="background-image:url({{URL('/')}}/public/plugins/frontend/images/image_1.jpg)"></a>
                        <div class="text">
                            <h3 class="heading"><a href="#">Bantuan Hukum Keliling Mendekatkan Upaya Akses Bantuan</a>
                            </h3>
                            <div class="meta">
                                <div>
                    ...
                    <div class="block-21 mb-4 d-flex">
                        <a class="blog-img mr-4"
                            style="background-image:url({{URL('/')}}/public/plugins/frontend/images/image_2.jpg)"></a>
                        <div class="text">
                            <h3 class="heading"><a href="#">Bantuan Hukum Keliling Mendekatkan Upaya Akses Bantuan</a>
                            </h3>
                            <div class="meta">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        <a class="blog-img mr-4"
                            style="background-image:url({{URL('/')}}/public/plugins/frontend/images/image_3.jpg)"></a>
                        <div class="text">
                            <h3 class="heading"><a href="#">Bantuan Hukum Keliling Mendekatkan Upaya Akses Bantuan</a>
                            </h3>
                            <div class="meta">
