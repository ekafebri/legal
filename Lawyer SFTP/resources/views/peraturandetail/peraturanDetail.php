      ...
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                <a class="activation btn btn-warning" data-value="{{$m->status}}" id="{{$m->id}}" name="peraturan/status/">Test</a>
                <a href="#" name="peraturan" style="color:white" class="btn btn-info editPeraturan" id="{{$m->id}}" data-toggle="modal" data-target="#modalPeraturanEdit">Edit</a>
