               ...
               <table class="es-left" cellspacing="0" cellpadding="0" align="left"> 
                 <tr> 
                  <td class="es-m-p0r es-m-p20b" width="600" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td class="es-m-txt-c" align="left"><h1 style="color: #ffffff;line-height: 100%">{{$apk_name}}</h1></td> 
                      @if($apk_name == 'Bursa Hukum')
                      <td align="right"><p><img width="200px" src="{{url('public/plugins/frontend')}}/images/logo-bursa-hukum.png" alt=""></p></td> 
                      @else
                      <td align="right"><p><img width="200px" src="{{url('public/plugins/frontend')}}/images/logo-bursa-advokat.png" alt=""></p></td> 
                      @endif
                     </tr> 
                   </table></td> 
                 </tr> 
                 ...
                 <tr> 
                  <td width="530" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     ...
                     <tr> 
                      <td class="es-p10b" align="center"><h2>Hai {{$nama}}</h2><br></td> 
                     </tr> 
                     <tr> 
                  ...
                  <td width="530" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                      ...
                      <td class="es-p10t es-p10b es-p10r es-p10l" align="left"> 
                       <table style="width: 500px" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left" role="presentation"> 
                         <tr> 
                          ...
                          <td style="padding: 5px 0" width="20%" align="left"><p>{{$email}}</p></td> 
                         </tr> 
                       </table>
                      </td> 
                     </tr> 
                     ...
                     Click Disini 
                      ...
                      @if($apk_name == 'Bursa Hukum')
                       <a type="button"  href="{{url('client/change/'.$email.'/'.$token)}}">Ganti Password</a>
                      @else
                       <a type="button"  href="{{url('advokat/change/'.$email.'/'.$token)}}">Ganti Password</a>
                      @endif
                     </center>
                     <tr> 
               ...
               <table width="100%" cellspacing="0" cellpadding="0"> 
                 <tr> 
                  <td width="530" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td class="es-p25t" align="left"><h2 style="color: #ffffff;font-size: 24px">Best Regard,<br>{{$apk_name}}</h2></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
